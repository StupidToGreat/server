...
<main>
  <div class="content content--fixed">
    <header class="codrops-header">
      <h1 class="codrops-header__title">당신의 소비를 만족스럽게 바꿔드릴게요</h1>
    </header>
  </div>
  <div class="content">
    <div class="slideshow">
      <div class="slide slide--current">
        ...
        <h2 class="word word--1">Stupid To Great</h2>
      </div>
    </div>
    <nav class="slidenav">
      <button class="slidenav__item slidenav__item--next" onclick="location='/loginForm.do'"><h7>이왕쓸거 만족스럽게</h7><svg class="icon icon--navarrow">
        <use xlink:href="#icon-nav-arrow"></use></svg></button>
    </nav>
  </div>
</main>
